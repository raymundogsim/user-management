...
export const validateSignupData = (data) => {
    ...
    if (isEmpty(data.mobile)) errors.mobile = 'Contact number must not be empty';
    if (!isMobile(data.mobile)) errors.mobile = 'Contact number must be valid';
    ...
    if (isEmpty(data.civilStatus)) errors.civilStatus = 'Civil Status must not be empty';
